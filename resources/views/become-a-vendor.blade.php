                ...
                <div class="container create-store pb-1 pb-lg-10 mb-10">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 order-md-first">
                            ...
                            <h2 class="title text-left">Build your online store on Betaspend with just a click of a button</h2>
                ...
                <div class="banner parallax" data-parallax-options="{'speed': 10, 'parallaxHeight': '200%', 'offset': -99}"
                    ...
                    <div class="container">
                        <div class="banner-content text-center">
                            <h2 class="title title-center text-white font-weight-bold">Let’s talk about how we can make your
