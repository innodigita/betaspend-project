                        ...
                        <div class="product text-center">
                            ...
                            <div class="pid" style="display:none">{{$deal->id}}</div>
                                ...
                                <div class="product-price">
                                    <ins class="new-price">${{$deal->Price}}</ins><del class="old-price">${{$deal->Price-23}}</del>
                                </div>
                            </div>
                        </div>
                    </div>
                    @if( count( $dealsOfDay ) >10 && $dealsOfDay[8]->id==$deal->id) break;
                    @endif
@endforeach
<!------------------------------------------------------------------------------->
        ...
        @foreach( $new_arrivals as $new_ar )
                            <div class="product-wrap">
                                <div class="product text-center">
                                    <figure class="product-media">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="#">{{$new_ar->Product_name}}</a></h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 60%;"></span>
                                                <span class="tooltiptext tooltip-top"></span>
                                        ...
                                        <div class="product-price">
                                            <ins class="new-price">${{$new_ar->Price}}</ins>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            @if( count( $new_arrivals ) >10 && $dealsOfDay[9]->id==$new_ar->id) break;
                            @endif
    @endforeach
    <!----------------------------------------------------------------->
                            <!-------dust.txt------------>
     ...
     @foreach( $best_seller as $bst_sell )
                            ...
                            <div class="product-wrap">
                                <div class="product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="">{{$bst_sell->Product_name}}</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 100%;"></span>
                                        ...
                                        <div class="product-price">
                                            <ins class="new-price">${{$bst_sell->Price}} - $29.99</ins>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        @foreach( $most_popular as $mostP )            
                            ...
                            <div class="product-wrap">
                                <div class="product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="">{{$mostP->Product_name}}
                                            </a></h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 60%;"></span>
                                        ...
                                        <div class="product-price">
                                            <span class="price">${{$mostP->Price}}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        @foreach( $featured as $feat )
                            <div class="product-wrap">
                                <div class="product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="">{{$feat->Product_name}}</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 100%;"></span>
                                        ...
                                        <div class="product-price">
                                            <ins class="new-price">${{$feat->Price}} - $29.99</ins>
                                        </div>
                                    </div>
                                </div>
                            </div>
