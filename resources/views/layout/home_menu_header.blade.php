            ...
            <div class="header-top">
                <div class="container">
                    <div class="header-left">
                        <p class="welcome-msg">Welcome to Betaspend where you buy and earn!</p>
                    </div>
                    ...
                    <div class="header-right ml-4">
                        <div class="header-call d-xs-show d-lg-flex align-items-center">
                            ...
                            <div class="call-info d-lg-show">
                                ...
                                <a href="tel:#" class="phone-number font-weight-bolder ls-50">+2348188175196</a>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="inner-wrap">
                        <div class="header-left">
                         ...
                         <!-- End of Browse Category sticky Menu  -->
                        ...
                        <div class="header-right">
                            ...
                            <a href="become-a-vendor" class="btn btn-primary btn-rounded pl-2 pr-2 hover"><i class="w-icon-account pr-1"></i>Become A Vendor</a>
                        </div>
                    </div>
                </div>
            </div>
