            ...
            <nav class="breadcrumb-nav">
                <div class="container">
                    <ul class="breadcrumb shop-breadcrumb bb-no">
                        <li class="passed"><a href="{{ url('./product/cart') }}">Shopping Cart</a></li>
                        <li class="active"><a href="{{ url('./product/checkout') }}">Checkout</a></li>
                                        ...
                                        <div class="payment-methods" id="payment_method">
                                            ...
                                            <div class="accordion payment-accordion">
                                                ...
                                                <div class="card p-relative">
                                                    ...
                                                    <a href="#" class="text-primary paypal-que" 
                                                        onclick="javascript:window.open('#','WIPaypal',
