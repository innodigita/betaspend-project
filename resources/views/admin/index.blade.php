...
<aside id="left-panel" class="left-panel">
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="./"><img src="../assets/images/demos/demo5/betaspend-logo.png" alt="Logo"></a>
            <a class="navbar-brand hidden" href="./"><img src="../assets/images/demos/demo5/betaspend-logo.png" alt="Logo"></a>
        </div>
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="categories.php"><i class="menu-icon fa fa-fw fa-desktop"></i> Manage Categories </a>
                </li>
