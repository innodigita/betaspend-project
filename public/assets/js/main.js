...
function(t) {
    ...
    Wolmart.stickyContent = function() {
        ...
        e.prototype.refresh = function(t, e) {
            ...
            i.hasClass("fix-top") ? (i.css("margin-top", e.offsetTop + "px"),
            this.zIndex = this.options.max_index - e.index) : i.hasClass("fix-bottom") ? (i.css("margin-bottom", e.offsetBottom + "px"),
            this.zIndex = this.options.max_index - e.index) : i.css({
                transition: "opacity .5s",
                "z-index": this.zIndex
            }),
            this.options.scrollMode ? (this.scrollPos >= a && i.hasClass("fix-top") || this.scrollPos <= a && i.hasClass("fix-bottom") ? (i.addClass("fixed"),
            this.onFixed && this.onFixed(),
            i.hasClass("product-sticky-content") && Wolmart.$body.addClass("addtocart-fixed")) : (i.removeClass("fixed").css("margin-top", "").css("margin-bottom", ""),
            this.onUnfixed && this.onUnfixed(),
            i.hasClass("product-sticky-content") && Wolmart.$body.removeClass("addtocart-fixed")),
            this.scrollPos = a) : (i.addClass("fixed"),
            this.onFixed && this.onFixed()),
            i.is(".fixed.fix-top") ? (e.offsetTop += i[0].offsetHeight,
            Wolmart.sticky_top_height = e.offsetTop) : i.is(".fixed.fix-bottom") && (e.offsetBottom += i[0].offsetHeight)) : (i.parent().css("height", ""),
            ...
            Wolmart.popup({
                ...
                callbacks: {
                    beforeClose: function() {
                        t("#hide-mfp-content")[0].checked && Wolmart.setCookie("hideNewsletterPopup", !0, 7)
                    }
                }
            })
        }, 7500),
    ...
    Wolmart.Minipopup = function() {
        var e, a = 0, i = [], o = !1, n = [], s = !1, r = function() {
            if (!o)
...
function(t) {
    var e = {
        init: function() {
            ...
            function() {
                function e() {
                    s.find(".title").after('<p class="compare-count text-center text-light mb-0">(' + a + " Products)</p>"),
                    s.find(".compare-count").length > 1 && s.find("p:last-child").remove()
                }
                var a, i, o, n = [], s = t(".page-wrapper > .compare-popup");
                s.length || document.body.classList.contains("docs") || (t(".page-wrapper").append('<div class="compare-popup">                    <div class="container">                        <div class="compare-title">                            <h4 class="title title-center">Compare Products</h4>                        </div>                        <ul class="compare-product-list list-style-none">                            <li></li><li></li><li></li><li></li>                        </ul>                        <a href="#" class="btn btn-clean">Clean All</a>                        <a href="compare.html" class="btn btn-dark btn-rounded">Start Compare !</a>                    </div>                </div>                <div class="compare-popup-overlay">                </div>'),
                ...
                Wolmart.$body.on("click", ".product .btn-compare", function(o) {
                    ...
                    setTimeout(function() {
                        ...
                        r.toggleClass("w-icon-compare").toggleClass("w-icon-check-solid"),
                        r.attr("href", "compare.php"),
                        s.addClass("show")
                    }, 500);
...
function(t) {
    var e = {
      ...
      , o = function(a) {
        ...
        a.$thumbs.hasClass("owl-carousel") || a.$thumbs.addClass("owl-carousel").attr("class", a.$thumbs.attr("class").replace(/row|gutter\-\w\w|cols\-\d|cols\-\w\w-\d/g, "").replace(/\s+/, " ")).owlCarousel(t.extend(!0, a.isQuickView ? {
            onInitialized: n,
            onResized: n
        } : {}, e)))
    }
...
function(t) {
    ...
    function o(e) {
        var a, i = t(this), o = t(".main-content > .alert, .container > .alert");
        if (i.hasClass("disabled"))
            ...
            if (o.length)
                ...
                var n = '<div class="alert alert-success alert-cart-product mb-2"> <a href="cart`    " class="btn btn-success btn-rounded">View Cart</a>   <p class="mb-0 ls-normal">“' + (a = i.closest(".product-single").find(".product-title").text()) + '” has been added to your cart.</p> <a href="#" class="btn btn-link btn-close"><i class="close-icon"></i></a> </div>';
    ...
    Calendar.prototype.render = function(e, a) {
        ...
        for (var p = l; p < c; p.setDate(p.getDate())) {
            for (var m = t("<tr></tr>"), h = 0; h < 7; h++) {
                ...
                p.toDateString() == (new Date).toDateString() && f.find(".day").addClass("today"),
                p.getMonth() != e.getMonth() && f.find(".day").addClass("disabled"),
                m.append(f),
